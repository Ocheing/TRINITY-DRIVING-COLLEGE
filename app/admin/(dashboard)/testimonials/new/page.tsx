...
export default function NewTestimonialPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setErrorMsg(error.message || 'Error creating testimonial. Please try again.');
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className="max-w-2xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="bg-white shadow rounded-lg p-6 space-y-6">
                ...
                <div>
                    <label className="block text-sm font-medium text-gray-700">Student Profile Image (Optional)</label>
