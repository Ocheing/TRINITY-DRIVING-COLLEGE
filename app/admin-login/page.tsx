        ...
        <div className="min-h-screen bg-[#060d18] flex flex-col items-center justify-center px-4 relative overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-sm">
                ...
                <div className="flex flex-col items-center mb-8">
                    <div className="relative w-16 h-16 rounded-full overflow-hidden border border-brand/30 flex items-center justify-center mb-5 shadow-[0_0_35px_rgba(16,166,233,0.3)] bg-white/5">
                            <Image
                    ...
                    <p className="text-sm text-gray-500 mt-1">Trinity Driving School — Restricted Area</p>
                </div>
                ...
                {/* Link to sigup */}
                <p className="text-center text-xs text-gray-500 mt-6 mb-2">
                    Need an admin account?{' '}
                    <Link href="/admin-signup" className="text-brand hover:text-brand-light transition-colors">Sign up</Link>
                </p>

                {/* Subtle back link — not discoverable, just convenient */}
